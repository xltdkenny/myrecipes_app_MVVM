...
// ViewModel для управления рецептами
class MainRecipesViewModel : ViewModel() {
...
// Компонента Main_recipes
@Composable
fun Main_recipes(viewModel: MainRecipesViewModel = viewModel()) {
